...
arma::vec ecmprAffine::forward(const arma::vec& original, arma::vec parameters)const
{
	arma::vec outPt(2);
...
bool ecmprAffine::initialParameters()
{
...
bool ecmprAffine::parameters_optimization()
{
...
void ecmprAffine::updateDelta_2(bool bfirstTime)
{
	return ecmpr::updateDelta_2(bfirstTime);
	int nX = (int)m_modelData.n_rows;
	int nY = (int)m_observationData.n_rows;
	int ndim = (int)m_modelData.n_cols;
