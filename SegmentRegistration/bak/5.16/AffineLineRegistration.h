...
public :
	...
	cvline_polar inverse(const cvline_polar& l)const;
	...
	Eigen::MatrixX3d m_refData;
	Eigen::MatrixX3d m_srcData;
	Eigen::MatrixX3d m_transData;
	Eigen::VectorXd m_sList;
	...
	double distance(const cvline_polar& l1, const cvline_polar& l2);
